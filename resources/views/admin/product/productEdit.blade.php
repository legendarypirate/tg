...
@section('content-heading')
   ...
   Admin: Сургалт засварлах 869x434
...
<div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                                                      ...
                                                                      {!! Form::open(['url' => 'course/edit', 'method'=>'post', 'name'=>'editForm', 'role'=>'form','files' => true, 'enctype'=>'multipart/form-data' ]) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="short" class="form-control my-editor">{!!$course->short!!}</textarea>
                                       
                                        </div>
                                        <div class="form-group" >
                                            <label>Дэлгэрэнгүй мэдээ</label>
                                            <textarea style="height:500px;" name="long" class="form-control my-editor" >{!!$course->long!!}</textarea>
                                       
                                        </div>
                                        <div class="form-group">
                                            <label>Хугацаа</label>
                                            <input name="term" class="form-control" value="{{$course->term}}">
                                       
                                        </div>
                                        <div class="form-group">
                                            <label>Хичээлийн цаг</label>
                                            <input name="time" class="form-control" value="{{$course->time}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="Submit" class="btn btn-block btn-primary" value="Засах">
                                        </div>
                                        {!! Form::close() !!}
                                </div>
                                <script>
                                   documents.forms['editForm'].elements['author'].value='{{ $course->id}}'
                                </script>
                            </div> 
</div>       
