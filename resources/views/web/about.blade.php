...
<div class="container" style="margin-top:40px;"> 
  <div class="row">
    <h1>Компанийн танилцуулга</h1>
  </div>
  <div class="row">
    
    <div class="col-md-12 col-sm-12 col-xs-12 col-12 col-lg-12">
    ...
    <img src="{{asset('tunga')}}/img/comp.png" class="rounded mx-auto d-block col-md-12 col-sm-12 col-xs-12 col-12 col-lg-10" alt="...">
   

  </div>

  <div class="row" style="margin-top: 40px;"> <br>
    <h2>Зөвлөхүүд</h2>
  </div>
 ...
 <div class="container " style=" margin-top:50px; height:500px;">
  <section class="pt-5 pb-5 ">
      <div class="container">
          <div class="row">
              <div class="col-6">
                  <h3 class="mb-3" style="color:black;">What our client says</h3>
              </div>
