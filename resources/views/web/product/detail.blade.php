  ...
  <div class="container-lg">
        ...
        <div class="container">
          <a class="navbar-brand" href="#">
            <img src="img/logoo.png" alt="" width="100" height="50">
          </a>
        </div>
      </nav>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">Холбогдох</a>
          </li>
...
<div class="container" style="margin-top:40px;"> 
  <div class="row">
    <h1>Хөрөнгө оруулалтын шинжилгээ</h1>
  </div>
  <div class="row">
  ...
  <div class="container-fluid footer">
      <div class="container"> 
                <div class="row">
                    ...
                    <hr>
                    <div class="row">
                        TUN CONSULT 2020, All right reserved, it is prohibited to use the information on the site in any way.
                    </div>
                 </div>
        </div>
    </div>    
